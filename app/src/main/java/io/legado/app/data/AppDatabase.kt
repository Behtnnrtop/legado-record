...
import io.legado.app.data.dao.BookReadDayRecordDao
import io.legado.app.data.dao.BookReadSessionDao
...
import io.legado.app.data.dao.ReadRecordLegacyMappingDao
...
@Database(
    ...
    entities = [Book::class, BookGroup::class, BookSource::class, BookChapter::class,
        ...
        BookReadDayRecord::class, BookReadSession::class, ReadRecordLegacyMapping::class],
...
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract val readRecordLegacyMappingDao: ReadRecordLegacyMappingDao
    ...
    abstract val bookReadDayRecordDao: BookReadDayRecordDao
    abstract val bookReadSessionDao: BookReadSessionDao
