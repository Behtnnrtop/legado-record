...
object BackupConfig {
    ...
    val ignoreTitle = arrayOf(
        ...
        appCtx.getString(R.string.show_read_record),
    ...
    fun keyIsNotIgnore(key: String): Boolean {
        return when {
            ...
            PreferKey.showReadRecord == key && ignoreShowReadRecord -> false
    ...
    private val ignoreShowReadRecord: Boolean
        get() = ignoreConfig[PreferKey.showReadRecord] == true
